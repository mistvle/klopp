...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (subcommand === "reroll") {
            ...
            return interaction.reply({
                content: `${giveawayManager.CHECK} Giveaway **${id}** was rerolled. New winner(s): ${winners.map(w => `<@${w}>`).join(", ")}`,
                flags: 64
            });
        }
