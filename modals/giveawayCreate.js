...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const serverLink = interaction.fields.getTextInputValue("server_link")?.trim() || null;
        ...
        interaction.client.db.prepare(`
            ...
            (id, message_id, channel_id, guild_id, prize, duration, winner_count, end_time, server_link, entries, ended, winners)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(
            id,
            "pending",
